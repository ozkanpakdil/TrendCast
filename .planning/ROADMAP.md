...
- [x] 03-01-PLAN.md — Build shared InvertedIndex + unit tests + shared fixtures
- [x] 03-02-PLAN.md — Convert heuristic path to candidate-filtered + equivalence test
- [x] 03-03-PLAN.md — Route zeroshot/sentiment/LLM through the index + per-engine equivalence
- [x] 03-04-PLAN.md — Embedding/NER equivalence tests (naive-loop oracle, index not applicable)
