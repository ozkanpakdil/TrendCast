...
- [x] 07-01-PLAN.md — TikTok content-script scraper + normalizer (socials/index.ts, debounce + hash dedup, Promise.race timeout)
- [x] 07-02-PLAN.md — SocialSourceHealth map + TikTok graceful-degradation badge
- [x] 07-03-PLAN.md — Manual URL-paste fallback (COLLECT_TIKTOK_URL + background tab) + SRC-02 end-to-end wiring
...
| 7. TikTok Collector | 3/3 | Complete | 2026-08-23 |
| 8. Storage & ML Hardening | 3/3 | Complete | 2026-08-23 |
